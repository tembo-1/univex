        ...
        <div class='notebook__container'>
            <div class="notebook__top">
                ...
                <div class="notebook__btns">
                    <a href="javascript:void(0)" class="notebook__link btn btn--gry">Сохранить в Exel</a>
                    <a href="javascript:void(0)" class="notebook__link btn btn--blue">Счет на оплату</a>
                    <a href="javascript:void(0)" class="notebook__link btn btn--icon" style='--icon:url(&quot;/img/icons/03.svg&quot;)'>Изменить заказ</a>
                </div>
            </div>
                        ...
                        @foreach($orderItems as $orderItem)
                            <div class="table-block__item table-block__item--color" style='--color: #ffffff'>
                                <div class="table-block__row table-block__row--seven">
                                    ...
                                    <div class="table-block__column">
                                        <div class="table-block__info">
                                            <div class="table-block__text">{{ $orderItem->unit_price }}</div>
                                        </div>
                                    </div>
                                    <div class="table-block__column">
                                        <div class="table-block__info">
                                    ...
                                    <div class="table-block__column">
                                        <div class="table-block__info">
                                            <div class="table-block__text">{{ $orderItem->total_amount }}</div>
                                        </div>
                                    </div>
                        ...
                        <div class="block-notebook__inner">
                            <div class="block-notebook__info">
                                <div class="block-notebook__textarea">
                                    <textarea class="input" placeholder="Введите что-то..." data-autoheight data-autoheight-min="125" data-autoheight-max="300">{{ $order->comment }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
