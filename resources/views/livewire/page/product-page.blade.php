    ...
    <div class="breadcrumb">
        <ul class="breadcrumb__list breadcrumb__container">
            ...
            <li class="breadcrumb__item breadcrumb__item--active">
								<span>
									<span>
										Амортизатор кабины 223-305 O/O 14x50 MB Actros 1831-4144</span>
								</span>
            </li>
        </ul>
    </div>
                ...
                <div class="gallery-block__inner">
                            ...
                            <div class="gallery-block__swiper swiper-wrapper">
                                <a href="javascript:void(0)" class="gallery-block__slide swiper-slide">
                                    <div class="gallery-block__img">
                                        <picture>
                                            <img src="./img/gallery/01.webp" srcset="./img/gallery/01@2x.webp 2x" alt="">
                                        </picture>
                                    </div>
                                ...
                                <div class="gallery-block__swiper swiper-wrapper">
                                    <div class="gallery-block__gallery swiper-slide">
                                        <div class="gallery-block__image">
                                            <picture>
                                                <img src="./img/gallery/02.webp" srcset="./img/gallery/02@2x.webp 2x" alt="">
                                            </picture>
                                        </div>
                                    </div>
                                    <div class="gallery-block__gallery swiper-slide">
                                        <div class="gallery-block__image">
                                            <picture>
                                                <img src="./img/gallery/03.webp" srcset="./img/gallery/03@2x.webp 2x" alt="">
                                            </picture>
                                        </div>
                                    </div>
                                    <div class="gallery-block__gallery swiper-slide">
                                        <div class="gallery-block__image">
                                            <picture>
                                                <img src="./img/gallery/04.webp" srcset="./img/gallery/04@2x.webp 2x" alt="">
                                            </picture>
                                        </div>
                                    </div>
                                    <div class="gallery-block__gallery swiper-slide">
                    ...
                    <div class="gallery-block__content">
                        <div class="gallery-block__top" data-da=".gallery-block__inner, 992, 0">
                            ...
                            <div class="gallery-block__title">123 Амортизатор кабины 223-305 O/O 14x50
                                <br>
                                MB Actros 1831-4144
                            </div>
                        </div>
                        <div class="gallery-block__items">
                            <dl class="gallery-block__item">
                                ...
                                <dd class="gallery-block__value">90.19.13</dd>
                            </dl>
                            <dl class="gallery-block__item">
                                <dt class="gallery-block__category">Производитель:</dt>
                                <dd class="gallery-block__value">ONYARBI</dd>
                            </dl>
                        </div>
                        <div class="gallery-block__btns">
                            ...
                            <a href="javascript:void(0)" class="gallery-block__btn btn btn--icon" style='--icon:url(&quot;/img/icons/03.svg&quot;)'>Блокнот</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="manufacturer__body ">
                <aside class="manufacturer__aside aside">
                    ...
                    <div class="aside__inner">
                        <form action="#" class="aside__form form">
                                ...
                                <div class="form__fieldset-range range js-range" data-range>
                                    ...
                                    <div class="range__values js-range-values">
                                        <div class="range__value" data-value="от">
                                            <input id="rng2" class="input range__range-value" autocomplete="off" type="text" name="form-range[]" aria-label="Минимальное значение" placeholder="" data-range-min="198">
                                        </div>
                                        <div class="range__value" data-value="до">
                                            <input class="input range__range-value" autocomplete="off" aria-label="Максимальное значение" type="text" name="form-range[]" placeholder="" data-range-max="875000">
                                        </div>
                                    </div>
                                </div>
                                <div class="form__fieldset-inner">
                                    <div class="form__fieldset-checkboxs js-search">
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csssddd_1" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csssddd_1" class="checkbox__label">
                                                <span class="checkbox__text">Центральный склад</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csssddd_2" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csssddd_2" class="checkbox__label">
                                                <span class="checkbox__text">Партнерская сеть</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csssddd_3" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csssddd_3" class="checkbox__label">
                                                <span class="checkbox__text">Только в наличии</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csssddd_4" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                            ...
                            <fieldset class="form__fieldset">
                                ...
                                <div class="form__fieldset-search form">
                                    <div class="form__search">
                                        <div class="form__search-input">
                                            <input autocomplete="off" type="text" name="form[]" data-error="Ошибка" placeholder="Производитель..." class="input">
                                        </div>
                                ...
                                <div class="form__fieldset-checkboxs form__fieldset-checkboxs--radio">
                                    <div class="form__fieldset-checkbox checkbox">
                                        <input id="csssss_1" data-error="Ошибка" class="checkbox__input" type="radio" value="1" name="form[]">
                                    ...
                                    <div class="form__fieldset-checkbox checkbox">
                                        <input id="csssss_2" data-error="Ошибка" class="checkbox__input" type="radio" value="1" name="form[]">
                                ...
                                <div class="form__fieldset-inner">
                                    <div class="form__fieldset-checkboxs form__fieldset-checkboxs--two js-search">
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_1" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_1" class="checkbox__label">
																<span class="checkbox__text">Orex
																</span>
                                                <span class="checkbox__value">от 567</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_2" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_2" class="checkbox__label">
																<span class="checkbox__text">ADAICO
																</span>
                                                <span class="checkbox__value">от 1 690</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_3" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_3" class="checkbox__label">
																<span class="checkbox__text">Takler
																</span>
                                                <span class="checkbox__value">от 4 540</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_4" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_4" class="checkbox__label">
																<span class="checkbox__text">Lokhen SRL
																</span>
                                                <span class="checkbox__value">от 2 540</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_5" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_5" class="checkbox__label">
																<span class="checkbox__text">Orex
																</span>
                                                <span class="checkbox__value">от 2 540</span>
                                            </label>
                                        ...
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_6" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_6" class="checkbox__label">
																<span class="checkbox__text">ADAICO
																</span>
                                                <span class="checkbox__value">от 2 540</span>
                                            </label>
                                        ...
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_7" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_7" class="checkbox__label">
																<span class="checkbox__text">Takler
																</span>
                                                <span class="checkbox__value">от 740</span>
                                            </label>
                                        </div>
                                        <div class="form__fieldset-checkbox checkbox">
                                            <input id="csss_8" data-error="Ошибка" class="checkbox__input" type="checkbox" value="1" name="form[]">
                                            <label for="csss_8" class="checkbox__label">
																<span class="checkbox__text">Lokhen SRL
																</span>
                                                <span class="checkbox__value">от 540</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form__bottom">
                                <button type="button" class="form__bottom-btn btn btn--blue">ПОКАЗАТЬ
                                    <span>56</span>
                                </button>
                            </div>
                        </form>
                                ...
                                <div class="table-block__items">
                                    ...
                                    <div class="table-block__item table-block__item--color" style='--color: #ECEEF2'>
                                        <div class="table-block__row table-block__row--twelve">
                                            <div class="table-block__column">
                                                <div class="table-block__info">
                                                    <a href="javascript:void(0)" class="table-block__text">90.19.13</a>
                                                </div>
                                            </div>
                                            <div class="table-block__column">
                                                <div class="table-block__info">
                                            ...
                                            <div class="table-block__column">
                                                <div class="table-block__info">
                                                    <div class="table-block__text">90.19.13</div>
                                                </div>
                                            </div>
                                            <div class="table-block__column table-block__column--big">
                                                <div class="table-block__info">
                                                    <div class="table-block__text">Амортизатор кабины 223-305 O/O 14x50 MB Actros 1831-4144IActros 1831-4144I</div>
                                                    <div class="table-block__attention">минимальный заказ от 10 шт.</div>
                                                </div>
                                            </div>
                                            <div class="table-block__column">
                                                <div class="table-block__info">
                                                    <div class="table-block__text">10
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="table-block__column">
                                                <div class="table-block__info">
                                                    <div class="table-block__text">МЦС
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="table-block__column">
                                            ...
                                            <div class="table-block__column">
                                                <div class="table-block__info">
                                                    <div class="table-block__text">2 540
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="table-block__column">
                                                <div class="table-block__info">
                                                    <a href="javascript:void(0)" class="table-block__basket" style='--icon:url(&quot;/img/icons/45.svg&quot;)'></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-block__item table-block__item--color" style='--color: #ECEEF2'>
                                        <div class="table-block__row table-block__row--twelve">
                                            ...
                                            <div class="table-block__column table-block__column--big">
                                                <div class="table-block__info">
                                                    <div class="table-block__text">Амортизатор кабины 223-305 O/O 14x50 MB Actros 1831-4144I</div>
                                                </div>
                                            </div>
                                            <div class="table-block__column">
                                                <div class="table-block__info">
