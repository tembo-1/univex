                ...
                <div class="menu__content">
                    ...
                    <div class="menu__constructor">
                        ...
                        <div class="menu__constructor-info">
                            ...
                            <a
                                href="{{ route('popup.callback') }}"
                                data-popup="#callback-popupTwo"
                        ...
                        <div class="menu__constructor-btns">
                            ...
                            @else
                                <a data-popup="#callback-popupThree" href="{{ route('popup.login') }}" class="menu__constructor-btn" style='--icon:url("{{ asset('img/icons/33.svg') }}")'></a>
                            @endif
                            @if($isAuth)
