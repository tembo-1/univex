            ...
            <div class="footer__info">
                <div class="footer__info-items">
                    <div class="footer__info-item">
                        <div class="footer__info-connection">
                            ...
                            <div class="footer__info-socials">
                                <a href="{{ setting('site_telegram') }}" class="footer__info-social" style='--icon:url("/img/icons/012.svg")'></a>
                                <a href="{{ setting('site_whatsapp') }}" class="footer__info-social" style='--icon:url("/img/icons/02.svg")'></a>
                            </div>
                        </div>
                    </div>
                    <div class="footer__info-item">
                    ...
                    <div class="footer__info-item footer__info-item--mobile">
                        <a href="{{ route('popup.callback') }}" data-popup="#callback-popupTwo" class="footer__info-btn btn btn--alt btn--icon" style='--icon:url("/img/icons/03.svg")'>Перезвоните нам</a>
                    </div>
                </div>
            </div>
        </div>
